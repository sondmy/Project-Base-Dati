...
\begin{lstlisting}[style=sqlstyle]
SELECT TC.nome AS cibo, SUM(D.quantita_kg_giorno) AS totale_kg
                     FROM ANIMALE A  +
                     ...
                     ORDER BY TC.nome
\end{lstlisting}
traduzione {Seleziona il nome del cibo e la somma totale del cibo necessario al giorno, raggruppata per tipo di cibo, considerando solo gli animali vivi.}
